...
pygame.display.set_caption("Pong V.11.0")
text_font = pygame.font.SysFont(None, 40, bold=False, italic=False)
...
#    yPad = SCREEN_HEIGHT - 10   
  ...
  draw_text('Brickbreaker game', text_font, (255, 255, 255), 200, 400)  

  text_font = pygame.font.SysFont('Arial', 20, bold=False, italic=False)

  img = text_font.render("My text", True, (255, 255, 255))
